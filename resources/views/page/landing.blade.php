...
<body class="font-ubuntu text-body text-tiny">
    <div class="overflow-x-hidden">
        ...
        <header id="sticky-header" class="fixed left-0 top-[15px] lg:top-[30px] xl:top-[45px] w-full z-10">
            ...
            " style="background-image: url('{{asset('assets/images/mega-menu/image.png')}}');">
        ...
        <section class="bg-[#FFF6F0] relative">
                                    ...
                                    <div class="col-span-12 lg:col-span-5 xl:col-span-6">
                                        <div class="slider-content">
                                            <div class="relative mb-5 sub_title">
                                                <img class="animate-animateSpin" src="{{asset('assets/images/hero/cogs.png')}}" width="62" height="62" alt="icon">
                      ...
                      class="text-[20px] sm:text-[22px] text-secondary">Have a question?</span> <a href="tel:9985254784" class="text-[22px] sm:text-[32px] text-primary hover:underline">+9985 254 784</a></span>
                                    ...
                                    <div class="col-span-12 lg:col-span-7 xl:col-span-6">
                                        <div class="relative mt-10 md:mt-0 lg:absolute xl:right-[30px] 2xl:right-[130px] lg:top-1/2 lg:-translate-y-1/2 3xl:max-w-[830px] 2xl:max-w-[700px] xl:max-w-[630px] lg:max-w-[550px]">
                                            <img class="hero_image" src="{{asset('assets/images/hero/hero.png')}}" width="849" height="739" alt="hero image">
            ...
            <img class="absolute left-0 bottom-0" src="{{asset('assets/images/hero/star.png')}}" width="112" height="138" alt="icon">
        </section>
            ...
            <div class="container">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                    ...
                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                        <div class="relative">
                            <a href="properties-details.html" class="block">
                                <img src="{{asset('assets/images/properties/properties1.jpg')}}" class="w-full h-full" loading="lazy" width="370" height="266" alt="Orchid Casel de Paradise.">
                            </a>
                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="{{asset('assets/images/icon/camera.png')}}" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="{{asset('assets/images/icon/video.png')}}" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                            </div>
                    ...
                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                        <div class="relative">
                            <a href="properties-details.html" class="block">
                                <img src="{{asset('assets/images/properties/properties2.jpg')}}" class="w-full h-full" loading="lazy" width="370" height="266" alt="Ruposibangla de parlosia.">
                            </a>
                            <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="{{asset('assets/images/icon/camera.png')}}" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                        ...
                        <div id="co-living2" class="properties-tab-content">
                            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                                ...
                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                                    <div class="relative">
                                        <a href="properties-details.html" class="block">
                                            <img src="{{asset('assets/images/properties/properties2.jpg')}}" class="w-full h-full" loading="lazy" width="370" height="266" alt="Sinomen Studio Palace.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img class="mr-1" src="{{asset('assets/images/icon/camera.png')}}" loading="lazy" width="13" height="10" alt="camera icon">07</button>
                                            <button class="flex flex-wrap items-center bg-[rgb(1,97,78,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img class="mr-1" src="{{asset('assets/images/icon/video.png')}}" loading="lazy" width="14" height="10" alt="camera icon">08</button>
                ...
                <div class="grid grid-cols-12 gap-[30px] items-center">
                    <div class="col-span-12 lg:col-span-6 relative">
                        <div class="mb-5 lg:mb-0 max-w-[450px]">
                            ...
                            <img class="absolute bottom-[-18px] right-[5px]" src="{{asset('assets/images/video/star.png')}}" loading="lazy" width="65" height="73" alt="image">
                    ...
                    <div class="col-span-12 lg:col-span-6 text-center">
                        <div class="relative rounded-[24px] pt-[45px] pr-[45px] z-[1] inline-block">
                            <div class="absolute top-0 right-0 bg-primary w-[90%] h-[90%] rounded-[24px] z-[-2]">
                                ...
                                <img src="{{asset('assets/images/video/shape.png')}}" class="absolute top-[18px] left-[-17px] z-[-1]" loading="lazy" width="68" height="56" alt="shape image">
                                <img src="{{asset('assets/images/video/shape.png')}}" class="absolute bottom-[15px] right-[15px] z-[-1]" loading="lazy" width="68" height="56" alt="shape image">
                            </div>
                            <div class="relative">
                                <div class="scene" data-relative-input="true">
                                    <img data-depth="0.1" src="{{asset('assets/images/video/video.png')}}" class="rounded-[24px]" loading="lazy" width="507" height="349" alt="video image">
                                </div>
                            ...
                            <div class="swiper  -mx-[30px] -my-[60px] px-[30px] py-[60px]">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency-details.html" class="block">
                                                <img src="{{asset('assets/images/cities/cities1.png')}}" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="New York">
                                    ...
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency-details.html" class="block">
                                                <img src="{{asset('assets/images/cities/cities2.png')}}" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="Sun Francisco">
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                    ...
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency-details.html" class="block">
                                                <img src="{{asset('assets/images/cities/cities3.png')}}" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="Washington D.C.">
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                    ...
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency-details.html" class="block">
                                                <img src="{{asset('assets/images/cities/cities4.png')}}" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="New York">
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                                    <span class="font-recoleta font-normal text-[24px] xl:text-lg text-primary group-hover:text-secondary transition-all">New York</span>
                                    ...
                                    <div class="swiper-slide text-center">
                                        <div class="relative group">
                                            <a href="agency-details.html" class="block">
                                                <img src="{{asset('assets/images/cities/cities2.png')}}" class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]" loading="lazy" width="270" height="290" alt="Francisco">
                                                <div class="cities-shadow bg-[#FFFDFC] rounded-[0px_0px_6px_6px] px-[15px] py-[20px]">
                                ...
                                <div class="swiper-slide">
                                    <div class="relative text-right">
                                        ...
                                        <div class="inline-block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-primary text-primary before:w-full before:h-[calc(100%_-_50px)] before:z-[-1] before:rounded-[16px]">
                                            <img src="{{asset('assets/images/testimonial/person1.png')}}" class="w-auto h-auto block mx-auto relative z-[2]" loading="lazy" width="300" height="380" alt="Oliver Stephen">
            ...
            <div class="container">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-x-[30px] mb-[-30px]">
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                <img src="{{asset('assets/images/team/person1.png')}}" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt="Albert S. Smith">
                            </a>
                        </div>
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                <img src="{{asset('assets/images/team/person2.png')}}" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt="Amelia Margaret">
                            </a>
                        </div>
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                <img src="{{asset('assets/images/team/person3.png')}}" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt="Stephen Kelvin">
                            </a>
                        </div>
                    ...
                    <div class="text-center group mb-[30px]">
                        <div class="relative rounded-[6px_6px_0px_0px]">
                            <a href="agent-details.html" class="block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-[#F5F9F8] before:w-full before:h-[calc(100%_-_60px)] before:z-[-1] before:rounded-[6px_6px_0px_0px]">
                                <img src="{{asset('assets/images/team/person4.png')}}" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt=" Michael Richard">
                            </a>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-[30px] mb-[-30px]">
                            <div class="mb-[30px]">
                                <a href="blog-details.html" class="block overflow-hidden rounded-[6px] mb-[30px]">
                                    <img class="w-full h-full" src="{{asset('assets/images/blog/post1.png')}}" width="370" height="270" loading="lazy" alt="Tip’s about Real Estate Recent Conditions from Agent.">
                                </a>
                                <div>
                            ...
                            <div class="mb-[30px]">
                                <a href="blog-details.html" class="block overflow-hidden rounded-[6px] mb-[30px]">
                                    <img class="w-full h-full" src="{{asset('assets/images/blog/post2.png')}}" width="370" height="270" loading="lazy" alt="Importance of Build quality of modern Real Estate.">
                                </a>
                                <div>
